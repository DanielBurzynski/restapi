package pl.przykladowastrona.restapi.maturity.hateoas;
...
import pl.przykladowastrona.restapi.maturity.Document;
...
@RequestMapping(value = "/api/maturity/l3/documents", produces = "application" + "/vnd.przykladowastrona.v2+hal+json")
